...
public class UserStepsController {
	...
	public ResponseEntity<List<StepDocument>> findStepDocsByStepId(@PathVariable("stepId") int stepId)
			throws Exception {
	...
	public ResponseEntity<UserStep> findStepDocsByStepId(@PathVariable("userId") String userId)
			throws Exception {
		logger.info("******* Start of findStepDocsByStepId() in controller ***********");
	...
	public ResponseEntity<List<Step>> getApplicationSteps()
			throws Exception {
